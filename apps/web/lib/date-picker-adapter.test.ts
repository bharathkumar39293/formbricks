...
describe("datePickerAdapter: Core Verification", () => {
  test("UTC Reconstruction: Should map local selection to UTC midnight anchor", () => {
    // Select Apr 26 (Local)
  ...
  test("Range Integrity: Should automatically swap inverted selections", () => {
  ...
  test("Structural Invalidation: Should reject corrupt inputs", () => {
